...
In this tutorial, you’ll install and use Docker Community Edition (CE) on [Ubuntu 20.04] (Docker/Docker Installation Steps.MD). You’ll install Docker itself, work with containers and images, and push an image to a Docker Repository.
